...
public class Utility  
	{
	     ...
	     * @return array of double type:It returns array of double type
	     * which contain random number 
	     */
...
/******************************Distinct_Coupon********************************************************/
	...
	/**
	 * This method is to create distinct coupon using among generated
	 * random numbers. 
	 * @param number:Total number of distinct coupon user want to generate 
	 * @return integer:It returns the integer value which contain count of
	 * distinct coupon.
	 */
...
/******************************Euclidean_Distance *****************************************************/	
	...
	/**
	 * This method is to find Euclidean Distance.It accepts two 
...
/********************************PowerOfTwo******************************************************/
/**
 * This method is to prints a table of the powers of 2
 *  that are less than or equal to 2^N.
 * @param number:It command-line argument to print table of
 * power of two till it reaches to value of number
 */
 ...
 * @return integer:It returns integer value contain prime factor
 *  of given number
 */
